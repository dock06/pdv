...
namespace PDV.Entities.Proveedores
{
    ...
    public class Proveedor : Resultado
    {
        ...
        public DataSet Consultar()
        {
            ...
            parametros.addParam("ClaveProveedor", ClaveProveedor);
            parametros.addParam("NombreProveedor", Nombre);
            parametros.addParam("TipoProveedor", ClaveTipoProveedor);
            ...
            DataSet ds=  DB.executeSP("SpConsultaProveedores", parametros);
            if (ds.Tables[0].Rows.Count == 1)
            {
                this.ClaveProveedor = int.Parse(ds.Tables[0].Rows[0]["CodigoProveedor"].ToString());
                ...
                this.ClaveTipoProveedor = int.Parse(ds.Tables[0].Rows[0]["ClaveTipoProveedor"].ToString());
                this.TipoProveedor = ds.Tables[0].Rows[0]["TipoProveedor"].ToString();
        ...
        public void Eliminar()
        {
            try
            {
                Parametros parametros = new Parametros();
                parametros.addParam("ClaveProveedor", ClaveProveedor);
                DataSet dsResultados = DB.executeSP("SpActivaInactivaProveedor", parametros);
        ...
        public void Modificar()
        {
            try
            {
                ...
                DataSet dsResultados = DB.executeSP("SpModificarProveedor", parametros);
                if (dsResultados != null)
                {
                    StatusOP = int.Parse(dsResultados.Tables[0].Rows[0]["Result"].ToString());
                    Mensaje = dsResultados.Tables[0].Rows[0]["Mensaje"].ToString();
        ...
        public void Guardar()
        {
            try
            {
                Parametros parametros = new Parametros();
                obtenerParametros(parametros);
                DataSet dsResultados = DB.executeSP("SpInsertarProveedor", parametros);
                if (dsResultados != null)
                {
                    StatusOP = int.Parse(dsResultados.Tables[0].Rows[0]["Result"].ToString());
                    Mensaje = dsResultados.Tables[0].Rows[0]["Mensaje"].ToString();
        ...
        public void obtenerParametros(Parametros parametros)
        {
            ...
            parametros.addParam("ClaveTipoProveedor", ClaveTipoProveedor);
